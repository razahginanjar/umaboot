...
/**
 * JPA persistence model for {@code ${table.name}}.
 *
 * <p>This class lives in the outbound persistence adapter and is intentionally
 * decoupled from the domain {@link ${basePackage}.domain.model.${entityName}}.
 * Translation between the two happens in the {@code ${entityName}PersistenceMapper}.</p>
 */
<#if useLombok>
@Data
@NoArgsConstructor
