...
public final class UiText {
    ...
    private static final Map<String, HelpEntry> HELP = Map.ofEntries(
            ...
            Map.entry("Lombok version:", new HelpEntry("Explicit Lombok dependency version used when older Spring Boot lines need annotation processor coordinates.", "1.18.30")),
            ...
            Map.entry("Existing output:", new HelpEntry("Standalone behavior when the output directory already looks like a project.", "warn")),
    ...
    private static final Map<String, String> ID = Map.ofEntries(
            ...
            Map.entry("Lombok version:", "Versi Lombok:"),
            ...
            Map.entry("Existing output:", "Output existing:"),
            ...
            Map.entry("Revert", "Kembalikan"),
            Map.entry("Generate", "Generate"),
            Map.entry("Preview / Merge", "Preview / Merge"),
            Map.entry("Reset Preview / Merge", "Reset Preview / Merge"),
            ...
            Map.entry("Settings", "Pengaturan"),
            Map.entry("Logs", "Log"),
            Map.entry("Open Umaboot logs", "Buka log Umaboot"),
            Map.entry("Write the form values back to umaboot.yaml", "Tulis nilai form kembali ke umaboot.yaml"),
            Map.entry("Restore the form to the last loaded YAML state", "Kembalikan form ke state YAML terakhir dimuat"),
            Map.entry("Discard unsaved form changes?", "Buang perubahan form yang belum disimpan?"),
            Map.entry("Reverted form changes", "Perubahan form dikembalikan"),
            Map.entry("No form changes to revert", "Tidak ada perubahan form untuk dikembalikan"),
            Map.entry("Sync", "Sinkron"),
            Map.entry("Sync from YAML", "Sinkron dari YAML"),
            Map.entry("Reload the form from umaboot.yaml without saving", "Muat ulang form dari umaboot.yaml tanpa menyimpan"),
            Map.entry("Discard unsaved form changes and reload from YAML?", "Buang perubahan form yang belum disimpan dan muat ulang dari YAML?"),
            Map.entry("Synced from YAML", "Tersinkron dari YAML"),
            Map.entry("Failed to sync from YAML: ", "Gagal sinkron dari YAML: "),
            ...
            Map.entry("Discard active Preview / Merge choices without touching files", "Buang pilihan Preview / Merge aktif tanpa menyentuh file"),
            Map.entry("Umaboot: Reset Preview / Merge", "Umaboot: Reset Preview / Merge"),
            Map.entry("No active Preview / Merge choices to reset.", "Tidak ada pilihan Preview / Merge aktif untuk direset."),
            Map.entry("Reset active Preview / Merge choices? This does not touch files already written.", "Reset pilihan Preview / Merge aktif? Ini tidak menyentuh file yang sudah ditulis."),
            Map.entry("Reset", "Reset"),
            Map.entry("Preview / Merge choices reset.", "Pilihan Preview / Merge direset."),
            Map.entry("Preview / Merge choices were reset; skipped %s.", "Pilihan Preview / Merge sudah direset; melewati %s."),
    ...
    private static final Map<String, String> JA = Map.ofEntries(
            ...
            Map.entry("Lombok version:", "Lombokバージョン:"),
            ...
            Map.entry("Apply", "適用"),
            Map.entry("Revert", "元に戻す"),
            Map.entry("Generate", "生成"),
            Map.entry("Preview / Merge", "プレビュー / マージ"),
            Map.entry("Reset Preview / Merge", "プレビュー / マージをリセット"),
            Map.entry("Summary Log", "概要ログ"),
            Map.entry("Detail Log", "詳細ログ"),
            Map.entry("Copy", "コピー"),
            Map.entry("Clear", "クリア"),
            Map.entry("Open in Settings", "設定で開く"),
            Map.entry("Settings", "設定"),
            Map.entry("Logs", "ログ"),
            Map.entry("Open Umaboot logs", "Umabootログを開きます"),
            Map.entry("Write the form values back to umaboot.yaml", "フォームの値をumaboot.yamlへ書き戻します"),
            Map.entry("Restore the form to the last loaded YAML state", "最後に読み込んだYAMLの状態へフォームを戻します"),
            Map.entry("Discard unsaved form changes?", "未保存のフォーム変更を破棄しますか?"),
            Map.entry("Reverted form changes", "フォーム変更を元に戻しました"),
            Map.entry("No form changes to revert", "元に戻すフォーム変更はありません"),
            Map.entry("Sync", "同期"),
            Map.entry("Sync from YAML", "YAMLから同期"),
            Map.entry("Reload the form from umaboot.yaml without saving", "保存せずにumaboot.yamlからフォームを再読み込みします"),
            Map.entry("Discard unsaved form changes and reload from YAML?", "未保存のフォーム変更を破棄してYAMLから再読み込みしますか?"),
            Map.entry("Synced from YAML", "YAMLから同期しました"),
            Map.entry("Failed to sync from YAML: ", "YAMLからの同期に失敗しました: "),
            ...
            Map.entry("Discard active Preview / Merge choices without touching files", "ファイルを変更せずにアクティブなプレビュー/マージ選択を破棄します"),
            Map.entry("Umaboot: Reset Preview / Merge", "Umaboot: プレビュー / マージをリセット"),
            Map.entry("No active Preview / Merge choices to reset.", "リセットするアクティブなプレビュー/マージ選択はありません。"),
            Map.entry("Reset active Preview / Merge choices? This does not touch files already written.", "アクティブなプレビュー/マージ選択をリセットしますか? 書き込み済みファイルは変更しません。"),
            Map.entry("Reset", "リセット"),
            Map.entry("Preview / Merge choices reset.", "プレビュー/マージ選択をリセットしました。"),
            Map.entry("Preview / Merge choices were reset; skipped %s.", "プレビュー/マージ選択がリセットされたため %s をスキップしました。"),
