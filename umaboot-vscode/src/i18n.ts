...
const TRANSLATIONS: Record<'id' | 'ja', Record<string, string>> = {
    id: {
        ...
        'Reset Preview / Merge': 'Reset Preview / Merge',
        ...
        'clear active preview choices': 'hapus pilihan preview aktif',
        ...
        'Umaboot overlay: modified existing files were not overwritten. Open Preview / Merge?': 'Umaboot overlay: file existing yang berubah tidak ditimpa. Buka Preview / Merge?',
        'Umaboot overlay: generated changes need Preview / Merge. Open now?': 'Umaboot overlay: perubahan generated perlu Preview / Merge. Buka sekarang?',
        'Umaboot standalone: output already looks like an existing project ({0}).': 'Umaboot standalone: output sudah terlihat seperti project existing ({0}).',
        'Umaboot standalone: output already looks like an existing project. No files were written.': 'Umaboot standalone: output sudah terlihat seperti project existing. Tidak ada file yang ditulis.',
        'Overwrite': 'Timpa',
        'Clean Output': 'Bersihkan Output',
        ...
        'Accept {0} selected generated file(s)? This writes generated content to the configured output directory and replaces existing file content.': 'Terima {0} file generated yang dipilih? Ini menulis konten generated ke output directory dan mengganti konten file existing.',
        ...
        'Reset': 'Reset',
        'Umaboot preview: no active Preview / Merge choices to reset.': 'Umaboot preview: tidak ada pilihan Preview / Merge aktif untuk direset.',
        'Reset active Preview / Merge choices? This does not touch files already written.': 'Reset pilihan Preview / Merge aktif? Ini tidak menyentuh file yang sudah ditulis.',
        'Umaboot preview: Preview / Merge choices reset.': 'Umaboot preview: pilihan Preview / Merge direset.',
        'Umaboot preview: Preview / Merge choices were reset; no files were written.': 'Umaboot preview: pilihan Preview / Merge sudah direset; tidak ada file yang ditulis.',
        ...
        'Umaboot: failed to parse {0}; current form was not changed.': 'Umaboot: gagal parse {0}; form saat ini tidak diubah.',
    ...
    ja: {
        ...
        'Umaboot overlay: modified existing files were not overwritten. Open Preview / Merge?': 'Umaboot overlay: modified existing files were not overwritten. Open Preview / Merge?',
        'Umaboot overlay: generated changes need Preview / Merge. Open now?': 'Umaboot overlay: generated changes need Preview / Merge. Open now?',
        'Umaboot standalone: output already looks like an existing project ({0}).': 'Umaboot standalone: output already looks like an existing project ({0}).',
        'Umaboot standalone: output already looks like an existing project. No files were written.': 'Umaboot standalone: output already looks like an existing project. No files were written.',
        'Overwrite': 'Overwrite',
        ...
        'Accept {0} selected generated file(s)? This writes generated content to the configured output directory and replaces existing file content.': 'Accept {0} selected generated file(s)? This writes generated content to the configured output directory and replaces existing file content.',
        ...
        'Reset': 'リセット',
        'Umaboot preview: no active Preview / Merge choices to reset.': 'Umaboot preview: リセットするアクティブなプレビュー/マージ選択はありません。',
        'Reset active Preview / Merge choices? This does not touch files already written.': 'アクティブなプレビュー/マージ選択をリセットしますか? 書き込み済みファイルは変更しません。',
        'Umaboot preview: Preview / Merge choices reset.': 'Umaboot preview: プレビュー/マージ選択をリセットしました。',
        'Umaboot preview: Preview / Merge choices were reset; no files were written.': 'Umaboot preview: プレビュー/マージ選択がリセットされたため、ファイルは書き込まれませんでした。',
        ...
        'Umaboot: failed to parse {0}; current form was not changed.': 'Umaboot: {0} の解析に失敗しました。現在のフォームは変更されませんでした。',
