-- MySQL kitchen-sink schema for script-mode generation tests.
-- Covers self-reference, 1:1, 1:N, rich junction, pure junction,
-- inline ENUM, defaults, comments, optional FKs, composite FKs, indexes,
-- and MySQL identity syntax.
